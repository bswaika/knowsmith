...
export default function ServiceSectionTextComponent(props) {
    return (
        <div id={props.sectionName}>
            <Row className="lp-about-comp">
                ...
                <Col xs={12} sm={12} md={5} lg={4} className="lp-about-img-container">
                    <img src={require(`../assets/images/${props.image.path}`)} alt={props.image.altText} className="lp-about-img" />
                    <div className="lp-about-img-div lp-services-img-div"></div>
                </Col>
